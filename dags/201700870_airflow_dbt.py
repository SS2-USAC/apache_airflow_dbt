"""Pipeline de ventas del estudiante 201700870. Editar y entregar mediante PR."""
...
def pipeline_estudiante():
    ...
    verificar = SQLCheckOperator(
        ...
        sql=f"SELECT COUNT(*) = 10, COUNT(DISTINCT venta_id) = 10, SUM(monto_neto) = 3766.75 FROM {ESQUEMA}_marts.fact_ventas",
